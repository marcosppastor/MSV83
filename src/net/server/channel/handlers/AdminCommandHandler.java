    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        switch (mode) {
            ...
            case 0x03: // /ban <name>
                ...
                String reason = victim + " banido permanentemente por " + c.getPlayer().getName();
                ...
                if (target != null) {
                    ...
                    target.ban(reason);
                    target.sendPolice("Você foi banido permanentemente pelo #b" + c.getPlayer().getName() + " #k por uso de HACK.");
            ...
            case 0x04: // /block <name> <duration (in days)> <HACK/BOT/AD/HARASS/CURSE/SCAM/MISCONDUCT/SELL/ICASH/TEMP/GM/IPROGRAM/MEGAPHONE>
                ...
                reason = c.getPlayer().getName() + " usou /block para banir";
                target = c.getChannelServer().getPlayerStorage().getCharacterByName(victim);
                if (target != null) {
                    String readableTargetName = MapleCharacter.makeMapleReadable(target.getName());
                    String ip = target.getClient().getSession().getRemoteAddress().toString().split(":")[0];
            ...
            case 0x11: // Entering a map
                switch (slea.readByte()) {
                    case 0:// /u
                        StringBuilder sb = new StringBuilder("Jogadores neste mapa: ");
            ...
            case 0x18: // Maple & Mobhp
                ...
                c.getPlayer().dropMessage("HP do Monstro");
