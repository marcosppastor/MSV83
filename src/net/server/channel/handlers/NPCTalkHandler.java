    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (obj instanceof MapleNPC) {
            ...
            if (npc.getId() == 9010009) {
                if (c.isVisitante()) {
                    c.getPlayer().dropMessage(1, "Duey não está disponível para visitantes.");
                ...
                //} 
                    ...
                    if (!hasNpcScript) {
                        if (!npc.hasShop()) {
                            FilePrinter.printError(FilePrinter.NPC_UNCODED, "NPC " + npc.getName() + "(" + npc.getId() + ") não está codado ou está com algum erro.\r\n");
                            return;
