...
public final class Channel {
    ...
    public void setServerMensagem(String mensagem) {
        this.serverMessage = mensagem;
        broadcastPacket(MaplePacketCreator.serverMensagem(mensagem));
    }
    ...
    public void setRates() {
        ...
        if (dayy == 7 && hr >= 5 && hr < 21 || dayy == 1 && hr >= 5 && hr < 21 || dayy == 6 && hr >= 19 && hr < 23) {
            worldz.setExpRate(6);
            worldz.setServerMensagem("[Evento Automático] A taxa de expêriencia sofreu alteração. Aproveite!");
        } else {
            worldz.setExpRate(4);
            worldz.setServerMensagem("");
        }
    }
