...
public class Server implements Runnable {
    ...
    public void run() {
        ...
        try {
            p.load(new FileInputStream("propriedades.ini"));
        } catch (Exception e) {
            System.out.println("Houve um erro ao carregar o arquivo 'propriedades.ini'.\r\nPara corrigir, inicie o arquivo criar_propriedades.bat");
            System.exit(0);
        }

        System.out.println("MapleStory v0." + Messages.V_ORIGENS + " iniciando.\r\n");
        ...
        System.out.println("Carregando as skills");
        SkillFactory.loadAllSkills();
        System.out.println("As Skills foram carregadas em " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " segundos\r\n");
        timeToTake = System.currentTimeMillis();
        System.out.println("Carregando os items");
        MapleItemInformationProvider.getInstance().getAllItems();

        CashItemFactory.getSpecialCashItems();
        System.out.println("Os Items foram carregados em " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " segundos\r\n");
        timeToTake = System.currentTimeMillis();
        System.out.println("Carregando as quests");
        MapleQuest.loadAllQuest();
        System.out.println("As Quest's foram carregadas em " + ((System.currentTimeMillis() - timeToTake) / 1000.0) + " segundos\r\n");
        try {
            for (int i = 0; i < Integer.parseInt(p.getProperty("worlds")); i++) {
                System.out.println("Carregando propriedades do mundo " + i + "\r\n");
                ...
                world.setServerMensagem(p.getProperty("servermessage" + i));
                System.out.println("\r\nAs propriedades do mundo " + i + " foram carregadas\r\n");
            }
        } catch (Exception e) {
            System.out.println("Erro ao carregar o arquivo 'propriedades.ini'.\r\nPara corrigir, inicie o arquivo criar_propriedades.bat");
        ...
        System.out.println("Jogo carregado pela porta 8484\r\n");
        ...
        online = true;
        System.out.println("O MapleStory v0." + Messages.V_ORIGENS + " está online!");
    }

    public void shutdown() {
        try {
            Server.getInstance().broadcastMessage(MaplePacketCreator.serverNotice(6, "O jogo foi desligado. Tenha um bom dia!"));
    ...
    public void resetPin() {
        Server.getInstance().getWorld(0).setPin(null);
    }
