...
public class SkillFactory {
    ...
    private static Map<Integer, SummonSkillEntry> SummonSkillInformation = new HashMap<Integer, SummonSkillEntry>();
    ...
    private final static ReentrantReadWriteLock.ReadLock readLock = locks.readLock();
...
//            case Cleric.BLESS:
    ...
    public static final Skill obterSkill(final int id) {
        if (!skills.isEmpty()) {
            readLock.lock();
            try {
                return skills.get(Integer.valueOf(id));
