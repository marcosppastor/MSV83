...
public enum MapleJob {
    ...
    Aprendiz(0),
    GUERREIRO(100),
    SOLDADO(110), TEMPLÁRIO(111), HERÓI(112),
    ...
    CLÉRIGO(230), SACERDOTE(231), SUMOSACERDOTE(232),
    ARQUEIRO(300),
    CAÇADOR(310), RASTREADOR(311), MESTREARQUEIRO(312),
    BALESTREIRO(320), ATIRADOR(321), ATIRADORDEELITE(322),
    GATUNO(400),
    MERCENÁRIO(410), ANDARILHO(411), LORDENEGRO(412),
    ARRUACEIRO(420), MESTREARRUACEIRO(421), MESTREDASSOMBRAS(422),
    PIRATA(500),
    LUTADOR(510), SAQUEADOR(511), BUCANEIRO(512),
    PISTOLEIRO(520), FORAGIDO(521), CORSÁRIO(522),
