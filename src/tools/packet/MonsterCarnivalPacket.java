...
public class MonsterCarnivalPacket {
    ...
    public static byte[] showMCStats(int left, int right) {
        ...
        //mplew.writeShort(SendOpcode.MONSTER_CARNIVAL_STATS.getValue());
        mplew.writeInt(left);
    ...
    public static byte[] showMCResult(int mode) {
        ...
        //mplew.writeShort(SendOpcode.MONSTER_CARNIVAL_RESULT.getValue());
        mplew.write(mode);
    ...
    public static byte[] showMCRanking(List<MapleCharacter> players) {
        ...
        //mplew.writeShort(SendOpcode.MONSTER_CARNIVAL_RANKING.getValue());
