...
public class FileoutputUtil {
    ...
    private static final SimpleDateFormat sdfGMT = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
    private static final SimpleDateFormat sdf_ = new SimpleDateFormat("dd-MM-yyyy");
