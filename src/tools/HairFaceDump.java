...
public class HairFaceDump {
    ...
    public static void main(String[] args) throws IOException {
        ...
        out = new FileOutputStream("Dump.js", false);
        ...
        System.out.println("Carregando a lista total disponivel de cabelos");
        root = data.getRoot();
        ...
        System.out.println("Carregando a lista total disponivel de faces");
        ...
        if (maleHair1.isEmpty() || maleHair2.isEmpty() || maleHair3.isEmpty() || femaleHair1.isEmpty() || femaleHair2.isEmpty() || femaleHair3.isEmpty() || maleFace.isEmpty() || femaleFace.isEmpty()) {
            System.out.println("Nao foi possivel encontrar cabelos ou faces.");
            System.exit(0);
            return;
        }
    ...
    public static String createStyler(List<Integer> maleHair1, List<Integer> maleHair2, List<Integer> maleHair3, List<Integer> femaleHair1, List<Integer> femaleHair2, List<Integer> femaleHair3, List<Integer> maleFace, List<Integer> femaleFace, List<Integer> hairList, List<Integer> faceList) {
        ...
        addLine(sb, "   cm.sendSimple(\"Ola #h #, meu nome é #eKin#n e posso mostrar-lhe o que tenho de melhor!\\r\\nO que voce gostaria que eu fizesse por voce?\\r\\n#L0#Alterar cor de pele#l\\r\\n#L1#Cabelos 1#l\" + (v13 == 0 ? ((\"\" + v7 != v9 ? \"\\r\\n#L2#Cabelos 2#l\" : \"\") + (\"\" + v7 != v11 ? \"\\r\\n#L3#Cabelos 3#l\" : \"\")) : ((\"\" + v8 != v10 ? \"\\r\\n#L2#Cabelos 2#l\" : \"\") + (\"\" + v8 != v12 ? \"\\r\\n#L3#Cabelos 3#l\" : \"\"))) + \"\\r\\n#L4#Cor dos cabelos#l\\r\\n#L5#Face#l\\r\\n#L6#Cor do Olho#l\");");
        addLine(sb, "}");
        addLine(sb, "");
        ...
        addLine(sb, "   cm.sendStyle(\"Escolha um\", v17);");
        addLine(sb, "}");
        addLine(sb, "");
