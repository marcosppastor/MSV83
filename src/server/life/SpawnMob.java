...
public class SpawnMob {
    ...
    public SpawnMob(final MapleMonster monster, final Point pos, final int mobTime, final int team) {
        super();
    ...
    public SpawnMob(final MapleMonster monster, final Point pos, final int mobTime) {
        super();
        this.monster = monster;
        this.pos = new Point(pos);
        this.mobTime = mobTime;
