...
public class MapleNPC extends AbstractLoadedMapleLife {
    ...
    public void sendSpawnData(MapleClient client) {
        // INÍCIO REMOÇÃO NPC MAPLE TV - TV MAPLE - OCULTAR NPC
        int[] npcId = ServerConstants.REMOVER_NPCS;
        //int[] npcId = {9000021, 9000036};
        for (int t = 0; t < npcId.length; t++) {
            if (getId() == npcId[t]) {
                return;
            }
        }
        // FIM REMOÇÃO NPC - OCULTAR
