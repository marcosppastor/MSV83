    ...
    public static Item addbyId_Gachapon(final MapleClient c, final int itemId, short quantity) {
        ...
        if (!type.equals(MapleInventoryType.EQUIP)) {
            ...
            if (!GameConstants.isRechargable(itemId)) {
                ...
                while (quantity > 0) {
                    ...
                    if (newQ != 0) {
                        ...
                        FilePrinter.printError(FilePrinter.OBTENÇÃO_GACHAPON + FilePrinter.ITEM_OBTIDO_GACHAPON + "", "O jogador " + c.getPlayer() + " obteve o item " + nItem + " no Gachapon em " + sdf.format(Calendar.getInstance().getTime()) + ".\r\n");
            ...
            if (quantity == 1) {
                ...
                FilePrinter.printError(FilePrinter.OBTENÇÃO_GACHAPON + FilePrinter.ITEM_OBTIDO_GACHAPON + "", "O jogador " + c.getPlayer() + " obteve o item " + item + " no Gachapon em " + sdf.format(Calendar.getInstance().getTime()) + ".\r\n");
