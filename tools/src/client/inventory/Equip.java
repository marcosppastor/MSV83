...
public class Equip extends Item {
    ...
    private byte vicioushammer = 0, enhance = 0, enhanctBuff = 0, reqLevel = 0, yggdrasilWisdom = 0, bossDamage = 0, ignorePDR = 0, totalDamage = 0, allStat = 0, karmaCount = -1;
    ...
    public void setQuantity(short quantity) {
        if (quantity < 0 || quantity > 1) {
            throw new RuntimeException("Setou a quantidade de " + quantity + " no item " + getItemId() + ")");
        }
        super.setQuantity(quantity);
        //Server.getInstance().broadcastGMMessage(MaplePacketCreator.sendYellowTip("Setou a quantidade de " + quantity + " no item " + getItemId() + ")"));
    }
