        ...
        switch (operation) {
            case 1: { // create
                if (player.getParty() == null) {
                    ...
                    c.announce(MaplePacketCreator.serverNotice(5, "Você não pode criar um grupo se você já estiver em um."));
                }
                break;
            }
            case 2: {
            ...
            case 3: {//join
                ...
                if (c.getPlayer().getParty() == null) {
                    ...
                    if (party != null) {
                        ...
                        c.announce(MaplePacketCreator.serverNotice(5, "A pessoa que você convidou para o grupo já está em um."));
                    }
                } else {
                    c.announce(MaplePacketCreator.serverNotice(5, "Você não pode participar do grupo se você já estiver em um."));
                }
                break;
            }
            case 4: {//invite
