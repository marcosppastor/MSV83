                    ...
                    if (MapleInventoryManipulator.addFromDrop(c, newItem, false)) {
                        ...
                        if (pItem.getBundles() < 1) {
                            ...
                            if (++boughtnumber == items.size()) {
                                ...
                                this.removeVisitors();
                                owner.dropMessage(1, "Seus itens estão esgotados e, portanto, sua loja está fechada.");
                            }
                        }
                    } else {
                        c.getPlayer().dropMessage(1, "Seu inventário está cheio. Limpe um slot antes de comprar este item.");
                    }
                }
            }
        }
