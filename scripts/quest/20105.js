...
function end(mode, type, selection) {
    ...
    if (status == 0) {
    	qm.sendYesNo("Voce esta certo? esta sera sua decisao final, e nao sera possivel voltar tras. Voce esta certo que deseja se tornar um Thunder Breaker?");
    } else if (status == 1) {
    	qm.sendNext("Espero ve-lo mais forte!");
