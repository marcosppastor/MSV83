...
function playerEntry(eim, player) {
    eim.broadcastPlayerMsg(5, "[Expedição] " + player.getName() + " entrou no mapa.");
...
function spawnGuardians(eim) {
    ...
    eim.broadcastPlayerMsg(5, "Os Guardiões Mestres o detectaram.");
...
function playerExit(eim, player) {
    eim.broadcastPlayerMsg(5, "[Expedição] " + player.getName() + " saiu do mapa.");
