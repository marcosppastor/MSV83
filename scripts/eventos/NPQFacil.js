...
function init() {
    mapaSaida = em.getChannelServer().getMapFactory().getMap(889100002); 
    mapaInicial = em.getChannelServer().getMapFactory().getMap(889100001); 
}
...
function spawnTylus(eim) {
    /* Tylus */
        ...
        var map = eim.getMapInstance(889100001);
        var tylus = MapleLifeFactory.getMonster(9500317);
