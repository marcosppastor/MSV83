...
function start() {
    ...
    moonRidge.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(6, "À medida que a luz da lua escurece, um grito de raposa longa pode ser ouvido e a presença da raposa velha pode ser sentida"));
	em.schedule("start", 3 * 60 *60 * 1000);
}