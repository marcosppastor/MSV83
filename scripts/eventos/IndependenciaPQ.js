...
function setup() {
	exitMap = em.getChannelServer().getMapFactory().getMap(109050001);
	finishMap = em.getChannelServer().getMapFactory().getMap(109050000);
	
	var instanceName = "IndependenciaPQ" + instanceId;
...
function playerEntry(eim, player) {
	var map = eim.getMapInstance(109010100);
	player.changeMap(map, map.getPortal(0));
        map.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(6, "[Evento] Destrua as caixas e colete as espadas, cuidado com as armadilhas!."));
	map.removePortals();
