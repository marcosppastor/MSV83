...
function init() {
    mapaSaida = em.getChannelServer().getMapFactory().getMap(889100012); 
    mapaInicial = em.getChannelServer().getMapFactory().getMap(889100011); // <main>
...
function respawn(eim) {	
        var map = eim.getMapInstance(889100011);
...
function spawnTylus(eim) {
    /* Tylus */
        ...
        var map = eim.getMapInstance(889100011);
        var tylus = MapleLifeFactory.getMonster(9400320);
