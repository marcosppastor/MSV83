...
function start() {
    ...
    goblinForest2.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(6, "O ar fantasmagórico por aqui tornou-se mais forte. O som desagradável de um gato chorando pode ser ouvido."));
	em.schedule("start", 3 * 60 *60 * 1000);
}