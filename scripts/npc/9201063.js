...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("Eu sou a assistente Ari. Se você tem #b#t5150030##k ou #b#t5151025##k por acaso, então, que tal me deixar mudar o seu penteado??\r\n#L0#Eu quero comprar um cupom!#l\r\n#L1#Corte de cabelo: #i5150030##t5150030##l\r\n#L2#Pintar meu cabelo: #i5151025##t5151025##l");
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 0;
                ...
                cm.sendYesNo("Se você usar o cupom NORMAL seu cabelo vai mudar aleatoriamente com a chance de obter um novo estilo experimental que eu criei. Você vai usar #b#t5150030##k e realmente mudar seu visual?");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("Se você usar o cupom NORMAL seu cabelo vai mudar aleatoriamente com a chance de obter um novo estilo experimental que eu criei. Você vai usar #b#t5151025##k e realmente mudar seu visual?");
            }
        }
        else if (status == 2){
            cm.dispose();
