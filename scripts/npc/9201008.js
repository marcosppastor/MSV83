...
function action(mode, type, selection) {  
    ...
    if (status == 0) {
		var text = "Estou aqui para ajudá-los em casamentos na capela !";
		...
		switch(selection) {
			...
			case 2:
				if (hasEngageRing) {
					//cm.warp(680000210, 2);
					cm.sendOk("Fale com o Wayne quando estiver pronto para se casar,lembre-se de ver todos os detalhes corretamente.");
					cm.dispose();
				} else {
