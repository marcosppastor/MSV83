		...
		if (mode == 1)
			...
			if (playerStatus) { // party leader
				if (status == 0) {
					...
					if (preamble == null) {
						cm.sendNext("Ola e bem vindo ao terceiro estagio da Missao de Ludibrium. \r\nNeste mapa ha algumas caixas e monstros. Quebre as caixas, mate os monstros e me colete #r32#k cupons.\r\nApos coletar a quantia exigida, fale comigo pois liberarei o portal para que voce possa seguir em frente.");
						...
						cm.dispose();
							...
							if (cm.haveItem(4001022, 32) == false) {
								cm.sendNext("Me desculpe, mas voce nao coletou os 32 cupons exigidos para prosseguir com a missao.");
								cm.dispose();
							}
							else {
								cm.sendNext("#bParabens#k por concluir o terceiro estagio!\r\nVou abrir o portal agora.");
								clear(1,eim,cm);
				...
				if (status == 0 && preamble == null) {
					...
					cm.sendNext("Ola e bem vindo ao terceiro estagio da Missao de Ludibrium. \r\nNeste mapa ha algumas caixase monstros. Quebre as caixas, mate os monstros e me colete #r32#k cupons.\r\nApos coletar a quantia exigida, fale comigo pois liberarei o portal para que voce possa seguir em frente.");
