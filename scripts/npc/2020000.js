...
function action(mode, type, selection) {
	...
	cm.dispose();
    if (status == 0 && mode == 1) {
	var selStr = "Hm? Quem é vocêr? Oh, você já ouviu falar sobre minhas habilidades de forjamento? Nesse caso, ficaria feliz em processar alguns dos seus minérios ... por uma taxa pequena...#b"
	...
	if (selectedType == 0){ //mineral refine
	    ...
	    var selStr = "Uma jóia rara? Em qual você estava pensando??#b";
	    ...
	    var selStr = "Minério de cristal? É difícil encontrar por aqui...#b";
	    ...
	    var materials = new Array ("Faça madeira processada com galho de árvore","Faça madeira processada com lenha","Fazer parafusos (pacote de 15)");
	    ...
	    var selStr = "Flechas? Não são um problema.#b";
	    var arrows = new Array ("Flecha para arco","Flecha para besta","Flecha de bronze para arco","Flecha de bronze para besta","Flecha de aço para arco","Flecha de aço para besta");
	...
	if (!complete) {
	    cm.sendOk("Eu nao posso refinar nada sem os itens necessários.");
	} else {
	    if (mats instanceof Array) {
		for (var i = 0; i < mats.length; i++){
	    ...
	    cm.sendOk("Tudo pronto, caso queira algo mais,só pedir..");
	}
	cm.dispose();
    }
}