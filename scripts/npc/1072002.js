...
function action(mode, type, selection) {
    if (mode == -1)
		...
		if (cm.haveItem(4031010)) {
			if (status == 0)
				cm.sendNext("Hmmm...it is definitely the letter from #bAthena#k...so you came all the way here to take the test and make the 2nd job advancement as a magician. Alright, I'll explain the test to you. Don't sweat it too much, it's not that complicated.")
			else if (status == 1)
