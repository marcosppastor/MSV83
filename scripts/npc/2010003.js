...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0 && mode == 1) {
        var selStr = "Olá. Eu sou o fabricante de luvas número um de Orbis. Gostaria que eu fizesse algo?#b"
        var options = new Array("Crie ou atualize uma luva de Guerreiro","Crie ou atualize uma luva de Arqueiro","Crie ou atualize uma luva de Bruxo","Crie ou atualize uma luva de Mercenario");
        ...
        if (selectedType == 0){ //warrior glove
            var selStr = "Luva de Guerreiro? Certo, e qual?#b";
            ...
            var selStr = "Luva de Arqueiro? Certo, e qual??#b";
            ...
            var selStr = "Luva de Bruxo? Certo, e qual?#b";
            ...
            var selStr = "Luva de Mercenario? Certo, e qual?#b";
        ...
        var prompt = "Você quer que eu faça um #t" + item + "#? Nesse caso, vou precisar de itens específicos de você para fazê-lo. Certifique-se de ter espaço em seu inventário!#b";
        ...
        if (!complete)
            cm.sendOk("Tenho medo de que os itens de substituição sejam inaceitáveis, se você deseja que suas luvas sejam feitas corretamente.");
        else {
            if (mats instanceof Array) {
                for (var i = 0; i < mats.length; i++){
            ...
            cm.gainMeso(-cost);
            cm.gainItem(item, 1);
            cm.sendOk("Feito. Se você precisar de mais alguma coisa, me chame novamente.");
        }
        cm.dispose();
    }
}