...
function action(mode, type, selection) {  
    ...
    switch (status) {
        case 0:
            cm.sendNext("Eu retiro daqui pessoas que estão aqui por engano.");
            break;
        case 1:
            ...
            if (cm.haveItem(4000313) && hasEngagement) {
                cm.sendOk("Por favor continue com o casamento.");
                cm.dispose();
            } else {
                cm.warp(680000000,0);
                cm.dispose();
            ...
            break;
        case 2:
            cm.sendOk("Você não tem os itens necessários para continuar com este casamento");
            break;
    }
}
