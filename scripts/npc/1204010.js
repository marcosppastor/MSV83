var status = -1;
var ask = "Oh, Você se tornou forte,vejo que está interessado em se tornar um Cavaleiro Cygnuus..";
var job;
var koc = new Array();

function start() {
   cm.sendNext("Hey #e#h ##n, Eu sou o encarregado pelo avanços das classes pertencentes aos guerreiros Cygnus de MapleStory");
}
    ...
    if (status == 0) {
        if (cm.getJobId() < 1000 ||cm.getJobId() % 10 == 2) {
            ...
            if (cm.getJobId() == 1000) {
                ...
                var list = "Qual tipo de #r Cavaleiro Cygnus #k você gostaria de ser                                                                                                                                                                                                                                                                                                                                                ?";
