        ...
        if (status == 0) {
            ...
            if ( cm.getLevel() < 70) {
               ...
               cm.dispose ();
                ...
                cm.sendOk("Você atingiu o level necessário,agora você é um Foragido!");
                cm.dispose();
                }
                
                if (cm.getJobId() == 510) {
                cm.changeJobById(511);
                cm.sendOk("Você atingiu o level necessário,agora você é um Saqueador!");
                cm.dispose();
                }
