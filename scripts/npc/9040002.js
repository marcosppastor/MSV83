...
function action(mode, type, selection) {
		...
		if (status == 0) {
                        ...
                        if (selectedOption == 0) {
                                ...
                                cm.sendNext("Mandei grupos de exploradores para Sharenian antes, mas nenhum deles jamais voltou, o que nos levou a iniciar o Missao de Cla. Nos estivemos esperando por guild's que sao fortes o suficiente para assumir desafios dificeis.");
                        }
                        ...
                        if (selectedOption == 0) {
                                ...
                                cm.sendNextPrev("O objetivo final desta Missao de Cla e explorar Sharenian e encontrar #t4001024#. Esta nao e uma tarefa em que o poder resolve tudo. Trabalho em equipe e mais importante aqui!");
                        }
                        else {
                                cm.dispose();
                        }
