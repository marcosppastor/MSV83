		...
		if (mode == 1)
			...
			if (playerStatus) { // party leader
				if (status == 0) {
					...
					if (preamble == null) {
						cm.sendNext("Ola, bem vindo a primeira Missao de Ludibrium.\r\nNeste lugar, voce tera de obter #r25#k cupons.Estes, por sua vez, sao obtidos ao matar os monstros do mapa.\r\nApos coletar a quantia exigida, fale comigo pois liberarei o portal para que voce possa seguir em frente.");
						...
						cm.dispose();
							...
							if (cm.haveItem(4001022, 25) == false) {
								cm.sendNext("Me desculpe, mas voce nao coletou os 25 cupons exigidos para prosseguir com a missao.\r\nMate mais monstros e colete a quantia necessaria.");
								cm.dispose();
							}
							else {
								cm.sendNext("#bParabens#k por concluir a primeira missao!\r\nVou abrir o portal agora.");
								clear(1,eim,cm);
