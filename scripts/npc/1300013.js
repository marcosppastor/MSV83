...
function action(mode,type,selection) {
	...
	switch(selection) {
		...
		if (next && (cm.getPlayer().isGM() || size >= 3)) {
			...
			cm.sendOk("Outro grupo já esta usando este canal,tente outro...");
		} else {
...
function start() {
//cm.gainItem()
//cm.sendOk(" #h #, estamos trabalhando para liberar todos os mapas disponíveis, Att Desenvolvedor TrueMS!!");
cm.warp(106021401);
cm.dispose();
}
