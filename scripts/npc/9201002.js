...
function action(mode, type, selection) {
    ...
    if (cm.getPlayer().getMapId() == 680000000) {
            ...
            if (selection == 0) {
               ...
               // if (cm.haveItem(5251003, 1)) {
                   ...
                   // cm.gainItem(5251100,5);
                          ...
                          cm.sendOk("Por favor fale com minha assistente Irmã Nicole.");
               ...
               // } 
                cm.dispose();
                    ...
                    cm.sendOk("Você pode comprar um Bilhete de Casamento na LOJA.");
                
                cm.dispose();
            } else if (selection == 4) {
            if ( !cm.haveItem(4031373)){
                    cm.sendNext("Por favor, vá visitar a a Mãe e o Pai em sua casa. Eles vivem em algum lugar em Área de caça de henesys II.");
                } else if (cm.getLevel() > 10 && cm.getPlayer().isMarried() == 0) {
        ...
        cm.sendOk("O casamento na capela só está disponível nos canais 1,2,3!")
